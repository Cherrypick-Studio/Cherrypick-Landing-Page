...
}) =>
{
    return (
        <div className="flex flex-col w-full gap-5">
            <Image src={img} alt="cherrypick-product-1" title="cherrypick-product-1" width={300} height={300} className="w-full" />
                ...
                <div className="flex gap-3">
                    ...
                    <div key={index} className="flex border border-[#DDDDDD] items-center px-4 py-2 gap-3 rounded-full">
                        <div className="w-2 h-2 bg-red-cherry-500 rounded-full" />
                            <Text size="h6" className="max-lg:text-xs">{item}</Text>
                        </div>
                    ))}
               </div>
            </div>
