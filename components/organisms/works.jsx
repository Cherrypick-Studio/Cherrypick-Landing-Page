  ...
  return (
    <div className='my-16 container mx-auto'>
      ...
      <div className='mt-12 space-y-[72px]'>
        {/* Laracamp */}
        <div className='grid grid-cols-1 lg:grid-cols-2 relative bg-gradient-to-r from-[#4D1DAB] to-[#7839F3] p-6 lg:py-[121px] lg:px-[103px] rounded-[32px]'>
          <Image
            ...
            height={364}
            width={364}
            className='absolute top-4 left-0 px-4 lg:px-0 lg:left-28'
          />
          <div className='z-20'>
            <Image
            ...
            <Text
              variant='white'
              size='h4'
              className='block w-full lg:w-[378px] mt-5 text-justify'
            >
          ...
          <div className='relative'>
            <Image
              ...
              height={452}
              width={481}
              className='lg:absolute -mb-14 lg:-top-20 lg:right-0'
            />
          </div>
        </div>
        {/* Shamo & Flutix */}
        <div className='relative grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-[72px] lg:gap-y-0'>
          ...
          <div className='relative flex flex-col bg-gradient-to-b from-[#1990A3] to-[#64C5D6] p-6 lg:py-10 lg:px-[103px] rounded-[32px]'>
            ...
            <div className='relative z-20 order-last lg:order-first'>
              <Image
                ...
                height={733}
                width={378}
                className='hidden lg:block -mt-20 mx-auto'
              />
              <Image
                ...
                height={733}
                width={378}
                className='block lg:hidden -mb-14 mx-auto'
              />
            </div>
            <div className='lg:mt-10 relative z-20'>
              ...
              <Text
                variant='white'
                size='h4'
                className='block w-full mt-5 text-justify'
              >
          ...
          {/* Flutix */}
          <div className='relative lg:h-[800px] bg-gradient-to-b from-[#E5DEFF] to-[#DAD3F7] p-6 lg:py-10 lg:px-[103px] max-h-[863px] rounded-[32px]'>
            <Image
            ...
            <div className='lg:mt-10 relative z-20'>
              <Image
                ...
                height={733}
                width={378}
                className='hidden lg:block absolute top-14 inset-x-0 mx-auto'
              />
              <Image
        ...
        <div className='flex flex-col lg:flex-row lg:space-x-10 relative bg-gradient-to-r from-[#4D55BC] to-[#343A84] p-6 lg:py-[121px] lg:px-[103px] rounded-[32px]'>
          ...
          <div className='relative w-full lg:w-1/2 order-last lg:order-first'>
            <Image
              ...
              height={452}
              width={481}
              className='lg:absolute -mb-14 lg:-top-20 lg:left-0'
            />
          </div>
          <div className='z-20 w-full lg:w-1/2'>
            ...
            <Text
              variant='white'
              size='h4'
              className='block w-full lg:w-[450px] mt-5 text-justify'
            >
