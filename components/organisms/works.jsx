  ...
  return (
    <section className="my-16 container mx-auto">
      ...
      <div className="mt-12 space-y-[72px]">
        {/* Laracamp */}
        <article className="grid grid-cols-1 lg:grid-cols-2 relative bg-gradient-to-r from-[#4D1DAB] to-[#7839F3] p-6 lg:py-[121px] lg:px-[103px] rounded-[32px] min-h-[550px]">
          <Image
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-[72px] lg:gap-y-0">
          {/* Shamo */}
          <article className="relative flex flex-col bg-gradient-to-b from-[#1990A3] to-[#64C5D6] p-6 lg:py-10 lg:px-[103px] rounded-[32px]">
            <Image
          ...
          {/* Flutix */}
          <article className="relative lg:h-[850px] bg-gradient-to-b from-[#E5DEFF] to-[#DAD3F7] p-6 lg:py-10 lg:px-[103px] max-h-[863px] rounded-[32px]">
            <Image
        ...
        {/* Micro */}
        <article className="flex flex-col lg:flex-row lg:space-x-10 relative bg-gradient-to-r from-[#4D55BC] to-[#343A84] p-6 lg:py-[121px] lg:px-[103px] rounded-[32px]">
          <Image
