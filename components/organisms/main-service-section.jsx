  ...
  const dummyData = [
    {
      ...
      title: "Development",
      description:
        "Turning ideas into real digital products is a valid indicator that beautiful designs can be created and implemented.",
    ...
    },
    {
      ...
      title: "UI/UX Design",
      description:
        "Designing interfaces by imagining, creating, and iterating products that solve user problems or meet specific needs.",
