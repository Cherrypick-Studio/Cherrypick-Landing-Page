  ...
  const ref = useRef(null);
    ...
    const dummyData =
        [
            ...
            description:'We start by understanding your goals, users, and business model. You can simply send us your requirements via email, or we’ll schedule a 30-minute briefing call to align on your needs. The goal is to uncover the real problems and opportunities before we design solutions.',
            icon: '/images/strategy-icon.svg',
        },
        {
          number: '02',
          title: 'Planning & Scope',
          description:'With a shared vision, we define the timeline, deliverables, and budget. We’re flexible and open to negotiation—we understand every business has different constraints, so we’ll help you prioritize features to stay within budget while still achieving your goals.',
          icon: '/images/plan-icon.svg',
        },
        {
          number: '03',
          title: 'UI/UX Design',
          description:'Our designers turn ideas into intuitive, elegant interfaces. Every screen and interaction is crafted with care, ensuring a seamless user experience that reflects your brand and keeps users engaged.',
          icon: '/images/design-icon.svg',
        },
        {
          number: '04',
          title: 'Development',
          description:'Using modern, scalable technologies, our developers bring the design to life—whether it’s a web app, mobile app, or backend system. We follow clean code standards and agile development practices for flexibility and efficiency.',
        ...
        },
        {
          ...
          description:"Once approved, we support your go-live with monitoring and optimization. Post-launch, we offer optional maintenance, version updates, or feature iteration depending on your needs.",
